...
def AStar_2_agents(obs, agents, prob_matrix, visited):
    actions = {}
...
def main():
    ...
    opt = {
        "drones_positions": [(15, 15), (23, 20)]
    }

    observations, info = env.reset(options=opt)

    visited = [set([opt['drones_positions'][0]]), set([opt['drones_positions'][1]])]
    ...
    while env.agents:
        ...
        actions = AStar_2_agents(observations, env.agents, prob_matrix, visited)
    ...
    df.to_csv('results/AStar_search_2_agents_1c.csv', index=False)